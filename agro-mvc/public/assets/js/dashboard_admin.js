...
const edit_employed = document.getElementById("edit_employed");
...
btn_poup.forEach((btn) => {
  btn.addEventListener("click", function () {
    if (btn.id == "edit") {
      employeds_table.forEach((employeds_table) => {
        if (employeds_table.contains(btn)) {
          console.log(edit_employed.children);
        }
      });
    }
  });
